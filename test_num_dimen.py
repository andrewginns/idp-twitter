...
for dimensions in range(50, 1051, 50):
    ...
    if len(test_data[0]) == len(train_data[0]):
    ...
    while a >= 1:
        ...
        with open('%d_dimen_%d_nn_Result.csv' % (n, k), 'wb') as csvfile:  # Creates .csv file to store the inputted tweet.
